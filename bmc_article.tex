...
To check the stability and conformation of the protein and ligand through the course of the simulatio we'll use RMSD, RMSF + explain
...
We provide an overview of ... apply this to an example. 
