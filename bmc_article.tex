...
This paper is a tutorial developed for the data analysis platform Galaxy. Galaxy's concept makes high-throughput computational data analysis, including in molecular dynamics, a structured, reproducible and transparent process. In this tutorial we
