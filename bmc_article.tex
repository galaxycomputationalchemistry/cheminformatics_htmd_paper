...
32.36\% of the variance (see PC1 vs PC2 and Eigenvalue rank plots in Figure \ref{fig:pca}. The RMSF is in good correlation with PC1 (not shown here).
