...
This paper is a tutorial developed for the data analysis platform Galaxy. Galaxy's concept makes high-throughput computational data analysis, such as molecular dynamics, a structured, reproducible and transparent process. In this tutorial we
...
This process runs the entire simulation and analysis procedure described so far to be run on the new ligands used. It uses Galaxy's collection~\cite{gtn_collections} feature to organize the data; each item in the history is a collection (essentially a directory) containing one file corresponding to each of the input ligands.
